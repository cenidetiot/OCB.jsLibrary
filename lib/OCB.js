...
class OCB {
    ...
    updateJSONAttrEntity(idEntity, nameAttribute,jsonAttr){
        ...
        //console.log(this._URLContext+'/entities/'+idEntity+'/attrs/'+nameAttribute);
    ...
    updateEntityAttrs(idEntity,jsonObjectAttrs){
        ...
        //console.log(this._URLContext+'/entities/'+idEntity+'/attrs/');
    ...
    updateEntityAttributeValue(idEntity, nameObjectAttribute, attrOfObject, val){
        ...
        //console.log(this._URLContext+'/entities/'+idEntity+'/attrs/'+nameObjectAttribute+'/'+attrOfObject);
    ...
    listEntities(){
        ...
        fetch(this._URLContext+'/entities/', options)
            .then(function(res) {
                ...
                if (res.status === 404){
                    console.log("Solicitud fallida. Entidades no encontradas");
                }
            })
            .then(function(json) {
                console.log(json);            
